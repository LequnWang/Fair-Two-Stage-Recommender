"""
Select top items from each group so that the sum of Platt scaling calibrated prediction scores is greater than
the target number of qualified items
"""
...
if __name__ == "__main__":
    ...
    for i in range(data_test_size):
        ...
        scores = calibration_model.predict_proba(logits)[:, 1]
